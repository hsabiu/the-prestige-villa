...
class Reservation extends JFrame {
	...
	String lastRes;
	int dateBetween;
	Color reservationColor = new Color(212, 216, 162);
	...
	public Reservation() {
		...
		s2 = s1 + (df.format(reservationCounter));
		...
		personelInfo.setMaximumSize(new Dimension(550, 200));
		personelInfo.setPreferredSize(new Dimension(550, 200));
		personelInfo.setMaximumSize(new Dimension(550, 200));
		...
		String[] countries = { "Belarus", "China", "England", "Germany", "Ghana", "Hungary", "Nigeria", "Niger", "Poland", "Ukraine", "USA" };
		...
		departureDate_Value.addActionListener(new ActionListener() {
		...
		roomType_Value.addItemListener(new ItemListener() {

...
public class MainFrame {
	...
	static JFrame HomeWindow; // Main frame of the system
	JToolBar myToolBar;
	JMenuBar myMenuBar;
	...
	public static JTable arrive_table;
	public static JTable depart_table;
	public static JTable allReservations_table;
	public static JCheckBox payed;
	public static JCheckBox checkIN;
	public static JButton home;
	public static JButton reservation;
	public static JButton room;
	public static JButton credit_card;
	public static JButton cancelButton;
	public static JButton postponedButton_1;
	public static JButton viewButton_1;
	public static JButton editButton;
	public static JCheckBox checkOut;
	public static JButton postponedButton_2;
	public static JButton viewButton_2;
	public static JButton viewRooms;
	public static JButton viewCostomer;
	public static JPanel centerDownPane;
	public static Font tableFont = new Font("Lucida Console", Font.PLAIN, 11);
	public static Font addInfoFont = new Font("Bookman Old Style", Font.PLAIN, 13);
	public static Color tableTextColor = new Color(94, 80, 80);
	...
	public MainFrame() {
		...
		home = new JButton("");
		home.setIcon(new ImageIcon(MainFrame.class.getResource("/com/habib/prestige/icons/Home.png")));
		...
		reservation.setIcon(new ImageIcon(MainFrame.class.getResource("/com/habib/prestige/icons/reservation.png")));
		...
		room = new JButton("");
		room.setIcon(new ImageIcon(MainFrame.class.getResource("/com/habib/prestige/icons/room.png")));
		...
		admin = new JButton("");
		admin.setIcon(new ImageIcon(MainFrame.class.getResource("/com/habib/prestige/icons/administrator.png")));
		...
		receptionist.setIcon(new ImageIcon(MainFrame.class.getResource("/com/habib/prestige/icons/waiter.png")));
		...
		credit_card.setIcon(new ImageIcon(MainFrame.class.getResource("/com/habib/prestige/icons/credit_card.PNG")));
		...
		exit.setIcon(new ImageIcon(MainFrame.class.getResource("/com/habib/prestige/icons/exit.png")));
		...
		ImageIcon Downbackground = new ImageIcon(LoginWindow.class.getResource("/com/habib/prestige/icons/upperFrame.PNG"));
		...
		JLabel downPaneLabel = new JLabel(" \u00a9 2014 - Developed By Habib Ado \u00ae\u2122, Final year project submitted to department of computer science, Bayero University Kano.  ");
	...
	public static JPanel userAccount() {
		...
		JLabel smallLogo = new JLabel(new ImageIcon(LoginWindow.class.getResource("/com/habib/prestige/icons/myLogo.png")));

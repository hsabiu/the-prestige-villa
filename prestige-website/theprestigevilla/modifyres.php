	  ...
	  <form action="modifyres.php" method="POST">
         <div class="row">
           <div class="col-xs-5">
             ...
             <input type="text" name="first_name" class="form-control" maxlength="30" required placeholder="Enter Your First Name" value="<?php if(isset($modify_fName)){ echo $modify_fName;}?>">
           </div>
           <div class="col-xs-5">
		     <label>Last Name <?php if(isset($lname)){if($f2 == true){echo '<b style="font-size: 20px; color: #FF0000;">*</b>';}} ?></label><br/>
             <input type="text" name="last_name" class="form-control" maxlength="30" required  placeholder="Enter Your Last Name" value="<?php if(isset($modify_lName)){ echo $modify_lName;}?>">
           </div>
         </div>
         <br>
         <div class="row">
           <div class="col-xs-5">
             ...
             <input type="someid" name="phone" onkeypress="return isNumberKey(event)" class="form-control" maxlength="20" required placeholder="Enter Your Phone No." value="<?php if(isset($modify_phoneNo)){ echo $modify_phoneNo;}?>">
           </div>
           <div class="col-xs-5">
         ...
         <div class="row">
           ...
           <div class="col-xs-5">
             ...
             <input type="text" name="id_no"class="form-control" maxlength="30" required placeholder="Enter Your ID No." value="<?php if(isset($modify_ID_no)){ echo $modify_ID_no;}?>">
           </div>
         </div>
         <br>
         <div class="row">
		 ...
		 <?php if($flag == true){ echo '<button type="submit" class="btn btn-primary" style="width: 100px">MODIFY</button>' ;} ?>
      </form>
	 </div>
    </div>
	<br/><br/><br/><br/>
